...
(function (global) {
    ...
    /*
     * Shell-glob match anchored to the whole string. Only "*" (any sequence)
     * and "?" (any single character) are wildcards; every other character,
     * including regular-expression metacharacters such as ".", is literal.
     */
