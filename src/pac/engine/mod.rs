...
//! specification) and the Microsoft IPv6 extensions (`dnsResolveEx`,
//! `isInNetEx`, ...).
//!
//! ```ignore
...
//!
//! The helper functions in `pac_helpers.js` and `pac_helpers_ms.js` are
//! implemented solely from the public PAC specification and Microsoft's
//! published IPv6 extension documentation; no code from any other PAC
//! implementation was used or consulted.
//!
